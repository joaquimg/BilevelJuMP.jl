...
function jump_01vec(optimizer, mode = BilevelJuMP.SOS1Mode(), config = Config())
    _jump_01(optimizer, true, mode, config)
    return
end

function jump_01(optimizer, mode = BilevelJuMP.SOS1Mode(), config = Config())
    _jump_01(optimizer, false, mode, config)
    return
end
...
function jump_03(optimizer, mode = BilevelJuMP.SOS1Mode(), config = Config())
    _jump_03(optimizer, false, mode, config)
    return
end
...
function jump_03_vec(
    ...
    _jump_03(optimizer, true, mode, config)
    return
end
...
function jump_06(optimizer, mode = BilevelJuMP.SOS1Mode(), config = Config())
    _jump_06(optimizer, false, mode, config)
    return
end

function jump_06_sv(optimizer, mode = BilevelJuMP.SOS1Mode(), config = Config())
    _jump_06(optimizer, true, mode, config)
    return
end
...
function jump_HTP_lin03(
    ...
    _jump_HTP_lin03(optimizer, false, mode, config)
    return
end
...
function jump_HTP_lin03_vec(
    ...
    _jump_HTP_lin03(optimizer, true, mode, config)
    return
end
...
function jump_DTMP_01_mod3vec(
    ...
    _jump_DTMP_01_mod3(optimizer, true, mode, config)
    return
end
...
function jump_DTMP_01_mod3(
    ...
    _jump_DTMP_01_mod3(optimizer, false, mode, config)
    return
end
