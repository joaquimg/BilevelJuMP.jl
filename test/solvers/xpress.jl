...
push!(solvers, (opt = XPR_BRIDGED, mode = BilevelJuMP.SOS1Mode()))
push!(solvers_sos, (opt = XPR_BRIDGED, mode = BilevelJuMP.SOS1Mode()))
push!(solvers_quad, (opt = XPR_BRIDGED, mode = BilevelJuMP.SOS1Mode()))
push!(solvers_sos_quad, (opt = XPR_BRIDGED, mode = BilevelJuMP.SOS1Mode()))