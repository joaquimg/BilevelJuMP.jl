...
function jump_01(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_02(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# Cap 3.2, Pag 25
function jump_03(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_04(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# Sec 3.4.1 , pag 32
function jump_05(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# sec 3.7 pag 59
function jump_3SAT(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# sec 5.1 pag 127
function jump_quad_01_a(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_quad_01_b(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_quad_01_c(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_int_01(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# sec 8.1 pag 257
function jump_int_02(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# pag 197 ex 5.1.1
function jump_06(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# pag 208 ex 5.3.1
function jump_07(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# pag 208 ex 5.3.1
function jump_08(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# pag 304 ex 8.1.2
function jump_09a(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_09b(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_10(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# pag 21 ex 2.1
function jump_11a(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_11b(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# pag 45 ex 3.3
function jump_12(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# pag 45 ex 3.3
function jump_13_quad(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# pag 290 ex 8.2
function jump_14(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# pag 300 ex 8.5.2
function jump_15a_INT(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_15b_INT(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# 9.2.2
function jump_HTP_lin01(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
# 9.2.3
function jump_HTP_lin02(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
# 9.2.4 - parg 211
function jump_HTP_lin03(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
# 9.2.5
function jump_HTP_lin04(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
# 9.2.6
function jump_HTP_lin05(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
# 9.2.7
function jump_HTP_lin06(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
# 9.2.8 - parg 216
function jump_HTP_lin07(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
# 9.2.9 - parg 217
function jump_HTP_lin08(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
# 9.2.10
function jump_HTP_lin09(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
# 9.2.11 - parg 219
function jump_HTP_lin10(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
function jump_jointc1(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
function jump_jointc2(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
=#
function jump_EffPointAlgo(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
...
=#
function jump_SemiRand(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
...
# Chapter 7.2, pag 281
function jump_DTMP_01(optimizer, mode = BilevelJuMP.SOS1Mode{Float64})
    # send y to upper level
