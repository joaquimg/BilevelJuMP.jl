function jump_nlp_01(optimizer; mode = BilevelJuMP.ProductMode(1e-8), config = Config())
...
function jump_nlp_02(optimizer; mode = BilevelJuMP.ProductMode(1e-8), config = Config())
...
function jump_nlp_03(optimizer; mode = BilevelJuMP.ProductMode(1e-8), config = Config())
...
function jump_nlp_04(optimizer; mode = BilevelJuMP.ProductMode(1e-8), config = Config())
